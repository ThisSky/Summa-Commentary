...
The existence of God can be demonstrated through posteriori, but not priori. That is to say we can know God exist because of his created effects, E.G., creation. We can not know God through His esscence as His being is infintie and therefore beyond our reason.
\paragraph{Objection 1.}
\paragraph{Objection 2.}
...
From Motion: The First Mover, or the Unmoved Mover. This explains why change is happening now. There must be a first mover that does not depend on temporal creation.

From Efficient Causality: First Efficient Cause, basically something had to get the ball rolling. This is different from First change as effect and cause are different.(?)

From Contingency and Necessity: The Necessary Being, creation is contingent on something as nothing can come from nothing. Therefore, there had to be a creator.

From Gradation: The Maximum of Perfection, if transcendentals such as goodness, or truth exists then there must be a perfect good and a perfect truth, which is God. God is the fullness of being, this is known as a participation argument.

From Governance: The Intelligent Govenor, natural, unintelligent things all act towards a end. ``Gotta make that money, man''
\cite{eazye}
