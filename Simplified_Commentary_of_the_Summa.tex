...
This question has to deal with the un-ending nature of God. It naturly flows from Q.9. that if God is unchanging over time, then over an infinite amount of time He would still remain unchanged. The definition of eternity Aquinas uses is the Simultanesously whole and perfect possession of interminable life. That is, active being for infinite time lacking nothing. Read Heaven.
\footnote{Some copies have 2 articles, some 6. Apparently, some editors broke apart the original 2 Aquinas wrote as to provide clarity.}
...
It flows from God's immutable self-generating nature that if He doesn't change then he won't change over infinite time.
\paragraph{Objection 1.}
\paragraph{Objection 2.}
\paragraph{Objection 3.}
\paragraph{Objection 4.}
...
Yes, they differ. Eternity is the whole existence in the presence of God. Time, particularly \textit{forever}, lacks the wholeness and is instead a measure unit of before, or after. See the intro.
\paragraph{Objection 1.}
\paragraph{Objection 2.}
\paragraph{Objection 3.}
\paragraph{On the contrary}
