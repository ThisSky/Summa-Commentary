...
Can we make a created thing that perfectly represents the infinite? No. By creating it we are imposing limits on the representation and therefore it by nature will fail. Attached is my illustration of infinity.
 \begin{figure}[h!]
    ...
    \caption{Representation of infinity. Note is limited to third order; for higher orders see \textit{Orthoganal Projection of Polynomial Space in n-th Dimensional Space.}+
