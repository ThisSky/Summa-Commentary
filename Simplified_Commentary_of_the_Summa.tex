...
In the previous question Aquinas defined what is goodness. He will now utilize this definition to outline why God is not only good, but goodness itself. This section will be essential to one of the ultimate conclusions of the summa is that God is the ultimate good.

\paragraph{Article 1. Whether God is good?}
The nuance of this article is that if \textit{good} describes how well one this is ordered to its end, how can God be good? The resolution to this delima is that God is in His \textit{essence} is goodness. That is that God is the highest end, the ultimate good. Further, all things ultimately desire perfection which exists to the highest degree in God. This reality resolves Obj 2.
\paragraph{Objection 1.}
\paragraph{Objection 2.}
\paragraph{On the contrary}
\paragraph{I answer that}
...
For Catholic readers, this article can be described as an expansion o and defense of the phrase "Source and summit" when describing the Eucharist.

God being good as He is the source of creation, its nuturing and its end, is consequentially the ultimate good. We can say that all things, bar God, is depended on its end to be attributted with the quality of good. God in His essence is goodness.
\paragraph{Objection 1.}
\paragraph{Objection 2.}
\paragraph{Objection 3.}
\paragraph{On the contrary}
